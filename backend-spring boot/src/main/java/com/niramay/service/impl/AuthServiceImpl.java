...
import com.niramay.repository.CartRepository;
import com.niramay.repository.UserRepository;
...
import com.niramay.service.EmailService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void sentLoginOtp(String email) throws UserException, MessagingException {
        ...
        String subject = "Niramay Login/Signup Otp";
    ...
    public String createUser(SignupRequest req) throws SellerException {
        ...
        if (user == null) {
            ...
            createdUser.setMobile("7030589067");
