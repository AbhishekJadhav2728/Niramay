...
const categoryTwo: { [key: string]: any[] } = {
    sportswears: healthLevelTwo,
    shoes: beautyLevelTwo,
    accessories: nutritionLevelTwo,
    
  };
  
  const categoryThree: { [key: string]: any[] } = {
    sportswears: healthLevelThree,
    shoes: beautyLevelThree,
    accessories: nutritionLevelThree,
