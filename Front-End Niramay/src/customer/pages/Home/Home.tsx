        ...
        {homePage.homePageData?.deals &&    <section className='pt-10'>
           ...
           {homePage.homePageData?.shopByCategories && <section className='flex flex-col justify-center items-center py-20 px-5 lg:px-20'>
            ...
            <section className='lg:px-20 relative h-[200px] lg:h-[450px] object-cover'>
                <img className='w-full h-full' src={"https://img.freepik.com/premium-photo/photo-vibrant-bouquet-flowers-against-serene-blue-backdrop-with-copy-space_176841-5694.jpg?ga=GA1.1.573206118.1738788490&semt=ais_hybrid"} alt="" />
                <div className='absolute top-1/2 left-4 lg:left-[15rem] transform  -translate-y-1/2 font-semibold lg:text-4xl space-y-3 '>
                    <h1 className=''>
                        Sell Your Product
                    </h1>
                    <p className='text-lg md:text-2xl'>With <strong className='logo text-3xl md:text-5xl pl-2'>Niramay</strong></p>
