      ...
      <div className="flex items-center justify-between px-5 lg:px-20 h-[70px] border-b">
        <div className="flex items-center gap-9">
          <div className="flex items-center gap-2">
            ...
            <h1
              onClick={() => navigate("/")}
              className="logo cursor-pointer text-lg md:text-2xl font-extrabold text-transparent 
          ...
          {user.user ? (
            ...
            >
              <Avatar
                ...
                src="http://static.vecteezy.com/system/resources/previews/002/002/403/non_2x/man-with-beard-avatar-character-isolated-icon-free-vector.jpg"
